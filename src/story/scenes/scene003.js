	...
	storyBeats: [
		{
					...
					show: [
						{
							...
							entityId: scene003.entities.htran_091.id,
							requiredPercentage: 100,
						},
						{
							type: c.objectiveTypes.forcedToFleeOrDestroyed.id,
							entityId: scene003.entities.mylok_1.id,
							requiredPercentage: 100,
						},
					],
					advanceWhen: [
			...
			execute(options) {
				scene003.handlers.storyStateFns.addFighterToPlayerHangar(
				...
				entities.spawn(scene003.entities.htran_091, {
					posX: 100,
					posY: 150,
				});
			...
			registerObjectives() {
				return {
					show: [
						{
							type: c.objectiveTypes.forcedToFleeOrDestroyed.id,
							groupId: scene003.entities.nazaar_1.groupId,
							requiredPercentage: 100,
						},
					],
					advanceWhen: [
